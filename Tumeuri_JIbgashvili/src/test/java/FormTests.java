...
public class FormTests {
    ...
    void fillAndCheck() throws InterruptedException {
        ...
        driver.findElement(By.id("firstName")).sendKeys("Temuri");
        driver.findElement(By.id("lastName")).sendKeys("Jibgashvili");
        driver.findElement(By.id("userEmail")).sendKeys("Temurijibgashvili@gmail.com");
        ...
        driver.findElement(By.xpath("//div[@class='react-datepicker__day react-datepicker__day--014']")).click();
        ...
        Assert.assertEquals(date.getText(), "14 December,2005");
        ...
        Assert.assertEquals(address1.getText(), "LAGODEKHI");
